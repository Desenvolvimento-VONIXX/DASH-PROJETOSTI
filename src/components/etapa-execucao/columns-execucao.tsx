...
import { statusEtapasExecucaoColors } from "@/utils/statusList";
...
export const getColumnsExecucao = (
    handleEditExecucao: (id: number) => void,
        ...
        },
        {
            ...
            cell: ({ getValue }) => {
                ...
                const color = statusEtapasExecucaoColors[status] || "text-gray-700 bg-gray-200";
                ...
                <div className="flex gap-1 justify-end">
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent className="max-w-20">
                            <DropdownMenuGroup>
                                <DropdownMenuItem onClick={() => handleEditExecucao(row.original.id_atv)}>
                                    <FilePenLine />
                                    <span>Editar</span>
                                </DropdownMenuItem>
                            </DropdownMenuGroup>
